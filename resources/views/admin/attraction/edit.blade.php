                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Destination Details</h1>
                                    </div>
                                    <form method="POST" action="{{ route('attractions.update',[$details->id]) }}" class="user" enctype="multipart/form-data">
                                        @csrf
                                        @method('PATCH')
                                    ...
                                    <input type="text" class="form-control new @error('place') is-invalid @enderror" name="place" value="{{$details->place}}" required autocomplete="email" placeholder="enter place">
