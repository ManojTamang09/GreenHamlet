...
class UserController extends Controller
{
    ...
    {
        $hod= User::all();
        return view('admin.usermaster.index',compact('hod'));
    ...
    {
        return view('admin.usermaster.create');
    }
    ...
    $user=  User::create([
      ...
      //  $role = Role::select('id')->where('name','user')->first();
        ...
        return redirect()->back()->with('message','User Data created successfully!!!');
    }
    ...
    public function edit($id)
    {
        ...
        $user = User::find($id);
        $role= Role::all();
        return view('admin.usermaster.edit',compact('user','role'));
    }
